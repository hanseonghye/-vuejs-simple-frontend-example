<template>
  <div class="columns is-multiline is-mobile">
    <div class="column is-half">
      <b-field id="fieldset-title" label="Title" message="Describe the Task">
        <b-input
          trim
          id="title-input"
          :required="true"
    ...
    <div class="column is-half">
      ...
      >
        <b-select expanded placeholder="Assignee" v-model="model.assignee_id">
          <option disabled selected value> -- Assignees -- </option>
          <option :value="user.id" v-for="user in assignees" :key="user.id">
            {{ user.email }}
          </option>
        </b-select>
      </b-field>
